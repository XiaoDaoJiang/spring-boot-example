package com.xiaodao.mail.service;

import cn.hutool.core.io.resource.ResourceUtil;
import com.xiaodao.mail.SpringBootDemoEmailApplicationTests;
...
public class MailServiceTest extends SpringBootDemoEmailApplicationTests {
	...
	public void sendSimpleMail() {
		mailService.sendSimpleMail("xiaodaojiang@qq.com", "这是一封简单邮件", "这是一封普通的SpringBoot测试邮件");
	}
