...
public class SampleTest {
    @Test
    void schemaFromSchemaLocationMappingMy() throws JsonMappingException, JsonProcessingException {
        ...
        JsonSchema schemaFromSchemaLocation = factory
                .getSchema(SchemaLocation.of("https://www.example.com/schema/main.json"));
        /*
        ...
        schemaFromSchemaLocation.getRefSchemaNode("");
        System.out.println(schemaFromSchemaLocation.getSchemaNode());
    }
    ...
    void schemaFromSchemaLocationMapping() throws JsonMappingException, JsonProcessingException {
         ...
         */
        JsonSchema schemaFromSchemaLocation = factory
                .getSchema(SchemaLocation.of("https://www.example.com/schema/mapping.json"));
        /*
         * By default all schemas are preloaded eagerly but ref resolve failures are not
         * thrown. You check if there are issues with ref resolving using
         * initializeValidators()
